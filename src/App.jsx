...
function App() {
  ...
  const customStyles = {
    ...
    mainContent: `h-screen z-10 flex-1 pb-20 overflow-y-auto overflow-x-hidden transition-all duration-300 relative z-10 w-full max-w-full min-h-0 md:pb-0 md:min-h-screen md:h-auto md:overflow-y-auto md:ml-[80px] md:w-[calc(100%-80px)] ${isReviewMode ? 'sm:overflow-hidden sm:p-0 sm:pb-0 sm:bg-transparent sm:border-0' : 'pt-4 md:px-8'}`,
